...
var (
	...
	EventServiceEndpointDefault   = "localhost:8181"
	BookingServiceEndpointDefault = "localhost:8182"
...
type ServiceConfig struct {
	...
	EventServiceEndpoint   string         `json:"event_service_endpoint"`
	BookingServiceEndpoint string         `json:"booking_service_endpoint"`
...
func ExtractConfiguration(filename string) (ServiceConfig, error) {
	conf := ServiceConfig{
		DBTypeDefault,
		DBConnectionDefault,
		EventServiceEndpointDefault,
		BookingServiceEndpointDefault,
